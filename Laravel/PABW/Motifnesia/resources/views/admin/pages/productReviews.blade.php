...
@section('content')
    ...
    <script>
        ...
        // Function ini dipanggil dari component
        function showNoReviewsNotification() {
            showToast('Belum Ada Ulasan di Produk Ini');
        }
        
        function toggleReviewsDropdown(productId) {
            const dropdown = document.getElementById('reviews-dropdown-' + productId);
            dropdown.classList.toggle('show');
        }
        
        // Close dropdown when clicking outside
        window.onclick = function(event) {
            if (!event.target.matches('.btn-view-reviews')) {
                const dropdowns = document.getElementsByClassName('reviews-dropdown-content');
