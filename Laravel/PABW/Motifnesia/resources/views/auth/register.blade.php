...
<body>
  <div class="container">
    ...
    <form action="" method="POST"> 
        {{-- Lu belum kasih route dan method POST yang benar untuk Register --}}
        {{-- Tambahkan @csrf jika ini form POST --}}
        ...
        <div class="input-box"><input type="password" name="password" id="password" placeholder="Password" required /></div>
        <div class="input-box"><input type="password" name="confirm_password" id="confirm_password" placeholder="confirm_password" required /></div>
        ...
        {{-- Pindahkan button ke luar input-box, dan tambahkan type="submit" --}}
